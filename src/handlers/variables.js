...
module.exports = {
  async execute(client) {
    ...
    client.loadingEmbed = new EmbedBuilder().setAuthor({ name: "Loading.... Please Wait", iconURL: client.embed.loadingicon, url: "https://discord.com/invite/rYHH2Tjz5e" }).setColor(client.embed.stanbycolor)
